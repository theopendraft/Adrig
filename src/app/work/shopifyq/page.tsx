...
export const metadata = {
  title: "ShopifyQ - Case Study | ADRIG AI Technologies",
  description:
    "Discover how ADRIG AI Technologies helped ShopifyQ achieve their goals with innovative AI solutions.",
};

export default function ShopifyQPage() {
  return (
    <>
      <AdrigNavbarTabs />
