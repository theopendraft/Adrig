...
export const metadata = {
  title: "SRM University - Case Study | ADRIG AI Technologies",
  description:
    "Discover how ADRIG AI Technologies helped SRM University achieve their goals with innovative AI solutions.",
};

export default function SRMUniversityPage() {
  return (
    <>
      <AdrigNavbarTabs />
