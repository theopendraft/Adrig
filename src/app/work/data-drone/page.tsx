...
export const metadata = {
  title: "Data Drone - Case Study | ADRIG AI Technologies",
  description:
    "Discover how ADRIG AI Technologies helped Data Drone achieve their goals with innovative AI solutions.",
};

export default function DataDronePage() {
  return (
    <>
      <AdrigNavbarTabs />
