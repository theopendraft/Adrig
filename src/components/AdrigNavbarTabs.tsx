...
function ServicesContent() {
  const servicesData = {
    ...
    "Data Engineering": {
      ...
      subOptions: [
        { name: "Data Engineering Services", description: "End-to-end data engineering for reliable pipelines", href: "/services/data-engineering-services" },
        { name: "Hire Data Scientists", description: "Augment teams with experienced data scientists", href: "/services/hire-data-scientists" },
        { name: "Data Analytics Service", description: "Analytics solutions for insights and decision-making", href: "/services/data-analytics-service" },
        { name: "Data Annotation Services", description: "High-quality labeling for ML and AI workloads", href: "/services/data-annotation-services" },
        { name: "ML Model Engineering", description: "Production-grade ML model design and delivery", href: "/services/ml-model-engineering" },
        { name: "Machine Learning Development", description: "Custom ML solutions from prototyping to production", href: "/services/machine-learning-development" },
        { name: "ML and Data Science Consulting", description: "Strategy and advisory for ML and data initiatives", href: "/services/ml-data-science-consulting" },
        { name: "Big Data Consulting", description: "Architecture and optimization for large-scale data", href: "/services/big-data-consulting" },
      ],
      href: "/services/data-engineering",
    },
    "Blockchain": {
      ...
      subOptions: [
        { name: "Blockchain Development", description: "Custom blockchain solutions for your business", href: "/services/blockchain-development" },
        { name: "Blockchain Consulting Services", description: "Strategic advisory and consulting for blockchain adoption", href: "/services/blockchain-consulting-services" },
        { name: "Substrate Development", description: "Build custom blockchains using Substrate framework", href: "/services/substrate-development" },
        { name: "Ethereum dApp Development Company", description: "Decentralized application development on Ethereum", href: "/services/ethereum-dapp-development-company" },
        { name: "Hyperledger Development", description: "Enterprise blockchain solutions with Hyperledger", href: "/services/hyperledger-development" },
        { name: "Hire Golang Developers", description: "Expert Golang developers for blockchain projects", href: "/services/hire-golang-developers" },
        { name: "Cosmos Blockchain Development Company", description: "Cosmos blockchain and interchain solutions", href: "/services/cosmos-blockchain-development-company" },
        { name: "Solana Development", description: "High-performance blockchain development on Solana", href: "/services/solana-development" },
        { name: "Tezos Development", description: "Self-amending blockchain development on Tezos", href: "/services/tezos-development" },
        { name: "Stellar Development", description: "Payment and financial solutions on Stellar network", href: "/services/stellar-development" },
        { name: "Smart Contract Audit", description: "Comprehensive security audits for smart contracts", href: "/services/smart-contract-audit" },
        { name: "Crypto Wallet Development Solution", description: "Secure cryptocurrency wallet development", href: "/services/crypto-wallet-development-solution" },
      ],
      href: "/services/blockchain",
    },
    "Hire Developers": {
