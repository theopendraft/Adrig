...
function ServicesContent() {
  const servicesData = {
    ...
    "Artificial Intelligence and ML": {
      ...
      subOptions: [
        { name: "AI Development", description: "End-to-end AI solution design and delivery" },
        { name: "AI Consulting", description: "Strategy, roadmap, and advisory for AI adoption" },
        { name: "AI Deployment Services", description: "Productionizing AI/ML models with MLOps best practices" },
        { name: "Hire AI Engineers", description: "Augment teams with experienced AI engineers" },
        { name: "AI as a Service", description: "Managed AI services tailored to your stack" },
        { name: "Hire Action Transformer Developers", description: "Specialists in modern transformer-based architectures" },
        { name: "Enterprise AI Development", description: "Scalable AI systems for enterprise workloads" },
        { name: "AI Chatbot Development Company", description: "Custom conversational AI tailored to your domain" },
        { name: "Enterprise AI Chatbot Development Company", description: "Enterprise-grade chatbots with compliance and security" },
        { name: "Transformer Model Development", description: "Custom transformer and foundation model builds" },
        { name: "ML Ops Consulting Services", description: "Pipelines, monitoring, and CI/CD for ML in production" },
      ],
      href: "/services/ai-ml",
    },
    "Data Engineering": {
