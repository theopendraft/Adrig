          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto text-center animate-slide-up">
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-8 font-semibold">
                At Adrig AI Technologies, we transform complex business data
                into simple, actionable insights - helping Indian companies make
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="animate-slide-up">
                ...
                <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                  Adrig AI Technologies is more than just a data analytics
                  company - we&apos;re your strategic AI partner. We believe in
                  harnessing the power of artificial intelligence to simplify
                  analytics. In a fast-paced Indian business landscape,
                  decision-makers need clarity and speed. Our platform helps
                  teams translate raw data into meaningful insights so they can
                  grow confidently.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-primary/5 to-blue-50 rounded-3xl p-8 md:p-12">
                <p className="text-lg text-gray-700 leading-relaxed mb-6">
                  ...
                  founders, we saw how many Indian businesses struggled with
                  their data: silos, delayed reports, and unclear trends. We set
                  out to change that.
                </p>
                <p className="text-lg text-gray-700 leading-relaxed">
                  With a lean team of data scientists and engineers, we built
                  our first prototype - a real-time analytics dashboard tailored
                  for SMEs. Feedback was strong, and soon we scaled. Today,
                  Adrig AI Technologies supports hundreds of Indian companies,
                  helping them become data-driven. And we&apos;re still growing
                  - expanding, innovating, and building smarter AI-powered tools
                  for everyone.
                </p>
              </div>
            </div>
